...
class RegisterUserForm(UserCreationForm):
    ...
    password2 = forms.CharField(label='Against password', widget=forms.PasswordInput(attrs={'class': 'form-input'}))
...
class UserPasswordChangeForm(PasswordChangeForm):
    ...
    new_password2 = forms.CharField(label='Success New Password', widget=forms.PasswordInput(attrs={'class': 'form-input'}))
